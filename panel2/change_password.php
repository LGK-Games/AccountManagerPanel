...
$encodedOld = password_hash($password, PASSWORD_BCRYPT);
// Substituir $2y$ por $2a$ no hash gerado
$encodedOld = str_replace('$2y$', '$2a$', $encodedPass);
...
$newEncoded = password_hash($password, PASSWORD_BCRYPT);
// Substituir $2y$ por $2a$ no hash gerado
$newEncoded = str_replace('$2y$', '$2a$', $encodedPass);
