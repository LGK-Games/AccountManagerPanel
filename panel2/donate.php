...
function buscarPersonagens($conn, $accountName) {
    $stmt = $conn->prepare("SELECT char_name, race FROM characters WHERE account_name = ? ORDER BY char_name ASC LIMIT 7");
...
<div class="container">
    ...
    <main class="main-panel">
		...
		<div class="character-grid">
			...
			$sql = "SELECT char_name, race FROM characters WHERE account_name = '$login' ORDER BY char_name ASC LIMIT 7";
