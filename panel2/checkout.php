	...
	<body>
      ...
      <section class="content">
		...
		<div class="character-grid">
			...
			$sql = "SELECT char_name, level, title, sex, exp, sp, karma, pvpkills, pkkills, online, onlinetime, nobless, race, classid FROM characters WHERE account_name = '$login' ORDER BY char_name ASC LIMIT 7";
