...
function template_settings()
{
	...
	'',	
        array(
			'id' => 'top_link_name_1',
			'label' => $txt['top_link_name_1'],
			'type' => 'text',
		),
        array(
			'id' => 'top_link_1',
			'label' => $txt['top_link_1'],
			'type' => 'text',
		),
        array(
			'id' => 'top_link_name_2',
			'label' => $txt['top_link_name_2'],
			'type' => 'text',
		),
        array(
			'id' => 'top_link_2',
			'label' => $txt['top_link_2'],
			'type' => 'text',
		),
        array(
			'id' => 'top_link_name_3',
			'label' => $txt['top_link_name_3'],
			'type' => 'text',
		),
        array(
			'id' => 'top_link_3',
			'label' => $txt['top_link_3'],
			'type' => 'text',
		),
        array(
			'id' => 'top_link_name_4',
			'label' => $txt['top_link_name_4'],
			'type' => 'text',
		),
        array(
			'id' => 'top_link_4',
			'label' => $txt['top_link_4'],
			'type' => 'text',
		),
	'',	
		array(
