	...
	echo '
			<div class="sub_bar">
			  ...
			  <div class="stats_flex_row">               
				<div class="stats_flex "><i class="fas fa-chart-pie"></i> <br> ', $context['common_stats']['boardindex_total_posts'], '</div>
				<div class="stats_flex "><i class="fas fa-user-alt"></i> <br> ', !empty($settings['show_latest_member']) ? ' ' . $txt['latest_member'] . ': <strong> ' . $context['common_stats']['latest_member']['link'] . '</strong>' : '', '</div>
				<div class="stats_flex "><i class="fas fa-comment-alt"></i> <br> ', (!empty($context['latest_post']) ? $txt['latest_post'] . ': <strong>&quot;' . $context['latest_post']['link'] . '&quot;</strong>  (' . $context['latest_post']['time'] . ')</div>' : ''), '
			  </div>';
}
